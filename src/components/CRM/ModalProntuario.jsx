      ...
      <div style={{ background: "#ffffff", borderRadius: "12px", border: "1px solid #e2e8f0", width: "100%", maxWidth: "1150px", height: "90vh", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", display: "flex", flexDirection: "column", overflow: "hidden", boxSizing: "border-box" }}>
        ...
        <div style={{ padding: "16px 24px", background: "#f8fafc", borderBottom: "1px solid #e2e8f0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ textAlign: "left" }}>
            <span style={{ fontSize: "10px", background: "#0f172a", color: "#ffffff", padding: "2px 6px", borderRadius: "4px", fontWeight: "700" }}>CONTA ESPELHO #{card.codigo}</span>
            <h2 style={{ margin: "4px 0 0 0", fontSize: "16px", fontWeight: "800", color: "#0f172a", textTransform: "uppercase" }}>🏢 {card.cliente}</h2>
          </div>
        ...
        <div style={{ flex: 1, display: "grid", gridTemplateColumns: "380px 1fr", overflow: "hidden", boxSizing: "border-box" }}>
          ...
          <div style={{ padding: "20px", borderRight: "1px solid #e2e8f0", overflowY: "auto", display: "flex", flexDirection: "column", gap: "16px", boxSizing: "border-box", background: "#f8fafc" }}>
            ...
            <div style={{ textAlign: "left" }}>
              <h4 style={{ margin: "0 0 6px 0", fontSize: "11px", fontWeight: "800", color: "#475569", textTransform: "uppercase", letterSpacing: "0.5px" }}>🔹 Ficha do Devedor Ativo</h4>
              <div style={{ background: "#ffffff", padding: "10px", borderRadius: "6px", border: "1px solid #e2e8f0", display: "flex", flexDirection: "column", gap: "6px", fontSize: "12px", fontWeight: "600", color: "#1e293b" }}>
                <div><span style={{ color: "#64748b" }}>Mesa / Gestor:</span> 👤 {card.responsavel || "Lucas Vieira"}</div>
            ...
            <div style={{ textAlign: "left" }}>
              <h4 style={{ margin: "0 0 6px 0", fontSize: "11px", fontWeight: "800", color: "#475569", textTransform: "uppercase", letterSpacing: "0.5px" }}>🔹 Canais de Acionamento Imediato</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                {card.contato && (
                  <div style={{ padding: "8px", background: "#ffffff", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", borderLeft: "3px solid #0f172a" }}>
                    <div style={{ fontWeight: "700", color: "#0f172a" }}>👤 {card.contato.nome} (Principal)</div>
                    <div style={{ fontSize: "11px", color: "#64748b" }}>Vínculo Fiscal: {card.contato.vinculo || "proprio"} | 📧 {card.contato.email}</div>
                    <div style={{ marginTop: "4px", fontWeight: "800", color: "#2563eb" }}>📞 {card.contato.telefone}</div>
                  </div>
                )}
                {contatosDesteDevedor.map((con) => (
                  <div key={con.id} style={{ padding: "8px", background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "6px", fontSize: "11px" }}>
                    <div style={{ fontWeight: "700", color: "#334155" }}>👤 {con.nome}</div>
                    <div style={{ color: "#64748b" }}>Papel: {con.tipoVinculo} | 📞 {con.telefone}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", background: "#f1f5f9", borderBottom: "1px solid #e2e8f0", padding: "0 12px" }}>
              <button type="button" onClick={() => setAbaAtiva("tarefas")} style={{ padding: "12px 16px", border: "none", background: abaAtiva === "tarefas" ? "#ffffff" : "none", borderBottom: abaAtiva === "tarefas" ? "2px solid #0f172a" : "none", color: "#0f172a", fontWeight: "700", fontSize: "12px", cursor: "pointer", textTransform: "uppercase" }}>📌 Ocorrências e Tarefas</button>
              <button type="button" onClick={() => setAbaAtiva("historico")} style={{ padding: "12px 16px", border: "none", background: abaAtiva === "historico" ? "#ffffff" : "none", borderBottom: abaAtiva === "historico" ? "2px solid #0f172a" : "none", color: "#0f172a", fontWeight: "700", fontSize: "12px", cursor: "pointer", textTransform: "uppercase" }}>📜 Histórico Analítico</button>
              <button type="button" onClick={() => setAbaAtiva("proposta")} style={{ padding: "12px 16px", border: "none", background: abaAtiva === "proposta" ? "#ffffff" : "none", borderBottom: abaAtiva === "proposta" ? "2px solid #0f172a" : "none", color: "#0f172a", fontWeight: "700", fontSize: "12px", cursor: "pointer", textTransform: "uppercase" }}>📊 Estratégia de Quitação</button>
            </div>
            ...
            <div style={{ flex: 1, padding: "20px", overflowY: "auto", boxSizing: "border-box" }}>
              ...
              {abaAtiva === "tarefas" && (
                <div style={{ display: "flex", flexDirection: "column", gap: "16px", textAlign: "left" }}>
                  <div style={{ background: "#f8fafc", padding: "14px", borderRadius: "8px", border: "1px solid #cbd5e1" }}>
                    <h5 style={{ margin: "0 0 8px 0", fontSize: "12px", fontWeight: "800", color: "#0f172a" }}>🔹 Agendar Novo Alerta / Retorno na Esteira</h5>
                    <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                      <select value={tipoTarefa} onChange={(e) => setTipoTarefa(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700", background: "white" }}>
                        <option value="Ligação">📞 Ligação Telefônica</option>
                        <option value="Mensagem">✉️ WhatsApp / SMS</option>
                        <option value="Reunião">📅 Reunião Conciliação</option>
                        <option value="Lembrete">🔔 Lembrete Sistema</option>
                      </select>
                      <input type="text" placeholder="Digitar instrução operacional técnica da tarefa..." value={textoTarefa} onChange={(e) => setTextoTarefa(e.target.value)} style={{ flex: 1, padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px" }} />
                      <button type="button" onClick={lidarAdicionarTarefaLocal} style={{ background: "#0f172a", color: "white", border: "none", padding: "6px 14px", borderRadius: "6px", fontSize: "12px", fontWeight: "700", cursor: "pointer" }}>Anexar</button>
                    </div>
                  </div>

                  <h5 style={{ margin: "8px 0 0 0", fontSize: "12px", fontWeight: "800", color: "#475569" }}>🔹 Fila de Ações Programadas</h5>
                  <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              ...
              {abaAtiva === "historico" && (
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", textAlign: "left" }}>
                  <h5 style={{ margin: "0 0 4px 0", fontSize: "12px", fontWeight: "800", color: "#0f172a" }}>📜 Linha do Tempo e Logs de Gravação de Lote</h5>
                  <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    {(card.historicoNotas || []).length === 0 ? (
                      <div style={{ fontSize: "11px", color: "#94a3b8", textAlign: "center", padding: "16px" }}>Nenhum histórico estruturado de minutas na fiação da conta.</div>
                    ) : (
              ...
              {abaAtiva === "proposta" && (
                <div style={{ display: "flex", flexDirection: "column", gap: "14px", textAlign: "left" }}>
                  ...
                  <div style={{ background: "#f1f5f9", padding: "10px", borderRadius: "8px", display: "flex", gap: "10px", border: "1px solid #cbd5e1" }}>
                    <button type="button" onClick={() => setRegimeLiquidacao("acordo")} style={{ flex: 1, padding: "8px", border: "none", borderRadius: "6px", background: regimeLiquidacao === "acordo" ? "#0f172a" : "none", color: regimeLiquidacao === "acordo" ? "white" : "#475569", fontWeight: "700", fontSize: "12px", cursor: "pointer", transition: "all 0.2s" }}>📋 Acordo Parcelado (Price)</button>
                    <button type="button" onClick={() => setRegimeLiquidacao("conta_corrente")} style={{ flex: 1, padding: "8px", border: "none", borderRadius: "6px", background: regimeLiquidacao === "conta_corrente" ? "#0f172a" : "none", color: regimeLiquidacao === "conta_corrente" ? "white" : "#475569", fontWeight: "700", fontSize: "12px", cursor: "pointer", transition: "all 0.2s" }}>⚡ Abatimento Livre (Conta Corrente)</button>
                  </div>

                  {regimeLiquidacao === "acordo" ? (
                    /* INTERFACE A: MOTOR FINANCEIRO PRICE */
                    <>
                      <h5 style={{ margin: "4px 0 0 0", fontSize: "12px", fontWeight: "800", color: "#0f172a" }}>📊 Mesa de Simulação de Faturamento de Acordos</h5>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", background: "#f8fafc", padding: "14px", borderRadius: "8px", border: "1px solid #e2e8f0" }}>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          ...
                          <input type="number" value={propostaValor} onChange={(e) => setPropostaValor(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700", color: "#2563eb" }} />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "4px" }}>DIVISÃO DE PARCELAS EXPANDIDA</label>
                          <input type="number" min="1" max="36" value={propostaParcelas} onChange={(e) => setPropostaParcelas(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700" }} />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "4px" }}>TAXA DE JUROS DE MORA (% A.M.)</label>
                          <input type="number" step="0.1" value={taxaJurosMensal} onChange={(e) => setTaxaJurosMensal(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700" }} />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "4px" }}>FORMA DE LIQUIDAÇÃO</label>
                          <select value={formaPagto} onChange={(e) => setFormaPagto(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700", background: "white" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gridColumn: "1 / -1" }}>
                          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "4px" }}>DATA DE CARÊNCIA DO PRIMEIRO VENCIMENTO</label>
                          <input type="date" value={dataPrimeiroVenc} onChange={(e) => setDataPrimeiroVenc(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700" }} />
                        </div>
                      </div>

                      <div style={{ background: "#eff6ff", border: "1px solid #bfdbfe", padding: "12px", borderRadius: "6px", fontSize: "12px" }}>
                        <div style={{ fontWeight: "700", color: "#1e40af", marginBottom: "4px" }}>📈 demonstrativo do Custo Efetivo Total (CET):</div>
                    ...
                    <>
                      <h5 style={{ margin: "4px 0 0 0", fontSize: "12px", fontWeight: "800", color: "#0f172a" }}>💰 Lançar Recebimento Avulso (Abatimento de Saldo)</h5>
                      <div style={{ background: "#f8fafc", padding: "14px", borderRadius: "8px", border: "1px solid #cbd5e1", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          ...
                          <input type="number" placeholder="0.00" value={novoAbatimento} onChange={(e) => setNovoAbatimento(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700", color: "#16a34a" }} />
                        </div>
                        <div style={{ display: "flex", flexDirection: "column" }}>
                          <label style={{ fontSize: "11px", fontWeight: "700", color: "#475569", marginBottom: "4px" }}>DATA DO DEPÓSITO</label>
                          <input type="date" value={dataAbatimento} onChange={(e) => setDataAbatimento(e.target.value)} style={{ padding: "6px 10px", border: "1px solid #cbd5e1", borderRadius: "6px", fontSize: "12px", fontWeight: "700" }} />
                        </div>
                        <button type="button" onClick={lidarLancarAbatimentoAvulso} style={{ gridColumn: "1 / -1", background: "#16a34a", color: "white", border: "none", padding: "10px", borderRadius: "6px", fontSize: "12px", fontWeight: "800", cursor: "pointer", textTransform: "uppercase" }}>Confirmar Abatimento e Recalcular Saldo Devedor</button>
                      </div>
        ...
        <div style={{ padding: "14px 24px", background: "#f8fafc", borderTop: "1px solid #e2e8f0", display: "flex", justifyContent: "flex-end", gap: "10px", alignItems: "center" }}>
          {colunaId === "finalizado" ? (
            <div style={{ display: "flex", width: "100%", justifyContent: "space-between", alignItems: "center" }}>
              <span style={{ fontSize: "12px", fontWeight: "800", color: "#ef4444" }}>🚨 CONCLUSÃO MANDATÓRIA DE CARTEIRA:</span>
              <div style={{ display: "flex", gap: "8px" }}>
                <button type="button" onClick={() => tratarSalvarDados("sucesso")} style={{ background: "#10b981", color: "white", border: "none", padding: "8px 14px", borderRadius: "6px", fontWeight: "700", fontSize: "12px", cursor: "pointer", textTransform: "uppercase" }}>🟩 Sucesso (Acordo Quitado)</button>
                <button type="button" onClick={() => tratarSalvarDados("insucesso")} style={{ background: "#ef4444", color: "white", border: "none", padding: "8px 14px", borderRadius: "6px", fontWeight: "700", fontSize: "12px", cursor: "pointer", textTransform: "uppercase" }}>🟥 Insucesso (Contencioso)</button>
              </div>
            </div>
          ) : (
            <>
              <button type="button" onClick={aoFechar} style={{ background: "#ffffff", border: "1px solid #cbd5e1", padding: "6px 14px", borderRadius: "6px", cursor: "pointer", fontSize: "12px", fontWeight: "600", color: "#475569" }}>Sair sem Salvar</button>
              <button type="button" onClick={() => tratarSalvarDados("")} style={{ background: "#0f172a", color: "#ffffff", border: "none", padding: "6px 18px", borderRadius: "6px", fontWeight: "700", fontSize: "12px", cursor: "pointer" }}>Salvar Prontuário</button>
            </>
          )}
        </div>
